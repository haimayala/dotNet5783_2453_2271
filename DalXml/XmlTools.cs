...
static class XMLTools
{
    ...
    internal static void SaveListToXMLElement(List<Product?> products, string s_products)
    {
        throw new NotImplementedException();
    }

    internal static void SaveListToXMLElement(List<Order?> orders, string s_orders)
    {
        throw new NotImplementedException();
    }

    internal static void SaveListToXMLElement(List<OrderItem?> items, string s_orderItems)
    {
        throw new NotImplementedException();
    }
    #endregion
